...
export default function SpeakerPanel({
  ...
  return (
    <div className="space-y-1">
      ...
      {speakers.length === 0 && (
        <p className="text-[13px] text-faint">No speakers identified.</p>
      )}
        ...
        {speakers.map((speaker) => (
          <li key={speaker.id} className="group">
            <div className="flex items-start justify-between gap-2">
              ...
              <div className="min-w-0 flex-1">
                {editingId === speaker.id ? (
                  <input
                    ...
                    className="w-full border border-border rounded px-2 py-0.5 text-[13px]
                  ...
                  <button
                    ...
                    disabled={readOnly}
                    className={`text-[13px] font-medium text-heading truncate ${
                      readOnly
                        ? "cursor-default"
              ...
              {/* Segment count */}
              <span className="text-[11px] text-muted whitespace-nowrap pt-0.5">
